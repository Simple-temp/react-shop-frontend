...
const ProductScreen = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const result = await axios.get(`https://shop-dwhw.onrender.com/api/products/details/${_id}`);
    ...
    const handleAddToCart = async () => {
        ...
        const { data } = await axios.get(`https://shop-dwhw.onrender.com/api/products/cart/${product._id}`)
